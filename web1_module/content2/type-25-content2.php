...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/content2/bootstrap.min.css">
        <link rel="stylesheet" href="css/content2/font-awesome.min.css">
        <link href="css/content2/daterangepicker.css" rel="stylesheet" type="text/css"/>
        <?php
        ...
        ?>
        <link rel="stylesheet" href="css/content2/type-25-content2.css">
        <script src="js/content2/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="js/content2/bootstrap.min.js" type="text/javascript"></script>
        <script src="js/content2/jquery.flot.js" type="text/javascript"></script>
        <script src="js/content2/jquery.flot.time.js" type="text/javascript"></script>
        <script src="js/content2/jquery.flot.spline.min.js" type="text/javascript"></script>
        <script src="js/content2/date.js" type="text/javascript"></script>
        <script src="js/content2/moment.min.js" type="text/javascript"></script>
        <script src="js/content2/daterangepicker.js" type="text/javascript"></script>
        <script src="js/content2/custom.min.js" type="text/javascript"></script>
    </head>
